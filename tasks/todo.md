...
- Cota do Gemini free tier pode expirar — neste caso o pipeline cai no fallback determinístico (regex/lexicon) automaticamente. Trocar `GEMINI_MODEL` no `.env` para `gemini-2.5-flash-lite` pode ajudar a re-aquecer o cache.
